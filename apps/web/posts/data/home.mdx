...
The Cosmos ecosystem was founded on the belief that the future of blockchain lies in specialized chains for specific applications,
...
However, until now, there has been no asset that directly represents the projects that make up and contribute to the growth of the Cosmos ecosystem.
That is why we created **$IBCX**, the **Interchain Basket of Coins**.

As the first fully-collateralized index token for Cosmos,
$IBCX offers a new way for Cosmonauts to directly invest in and support the growth of the Cosmos ecosystem.
Powered and governed by the **[ION DAO](https://ion.wtf)**,
$IBCX is a secure and easily deployable asset that reflects the potential of the Cosmos ecosystem and the projects that compose it.

You can learn more about $IBCX and the ION DAO at [https://ion.wtf](https://ion.wtf).
...
You can learn more about Bento and try it out for yourself at [https://bento.finance](https://bento.finance).
...
ZEP Studio uses Google's Blockly as its back-end, **while improving the user experience with a block-coding editor interface similar to Scratch.**
...
Contributed to Keplr Wallet Extension and built the first version of its web dashboard service, which has over 700K+ users.
...
**Pylon Protocol**, an protocol that powers DeFi savings and payment services on Terra using yield redirection, was among the protocols I worked on.
...
Pylon maintained an average TVL of $330M before the UST depeg incident and was later acquired.
...
As a part-time frontend engineer at **Toss**, a fintech unicorn currently valued at over $7.4B and the largest unicorn startup in South Korea,
I was responsible for building the landing page for **NEXT 2021**, a large-scale recruitment event with an achievement system.

I also contributed to the frontend of **Simplicity 21**, an internal design conference, and maintained web products such as Toss Feed 3.0, Home, and Notice.
...
Our team also made a number of open-source projects, including [devxoul/daumpostcode](https://github.com/devxoul/daumpostcode) and [check-mergeable](https://github.com/PocketLesson/check-mergeable).
...
I was responsible for BX design, UI/UX design, frontend development including the app, website, and the back office, and also provided architectural advice. Pointing was used at over 30 affiliates.
