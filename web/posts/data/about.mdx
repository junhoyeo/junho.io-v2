...
<Position>2025 - 2026</Position>

- Built a high-performance CLI tool and visualization dashboard for tracking token usage and costs across multiple AI coding agents
- Native Rust TUI with ~8.5x faster processing, supporting 15+ platforms including Claude Code, OpenCode, Codex CLI, Cursor, Gemini CLI, and more
- Includes a social platform with leaderboard, public profiles, and a GitHub-style 3D contribution graph

<Image alt="" src="/assets/about/tokscale-og.png" />
...
- Company building decentralized stablecoin, raised >$1.2M.
...
- Some of the ideas we explored was:
  - Multi-currency stablecoin with own monetary policy
...
Almost all of my works are on GitHub, and it got me 4,400+ stars and some grateful followers.
