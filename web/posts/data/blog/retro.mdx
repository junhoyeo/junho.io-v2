...
L1/L2 foundations, thirsty for ecosystem expansion, shower grants on anyone with a plausible idea. Every chain yearns for the next Uniswap or Aave to be born in their ecosystem, providing full EVM compatibility to make this inevitable. Thanks to this, successful cases on one chain get copypasta'd across all chains within 24 hours.
...
- How aligned are you with existing ecosystem products and their stakeholders?
  - This isn't just about financial engineering and incentives. How much can you enhance their reason to exist?
  - You don't need to kill competing products. If you don't harm each other's raison d'être, splitting the pie today is still attractive. You can always move faster later.
...
L1/L2 재단들은 생태계 확장에 목마른 나머지, 그럴듯한 아이디어만 있어도 그랜트(grant)를 뿌려댑니다. 각 체인은 다음 Uniswap이나 Aave가 자신들의 생태계에서 탄생하기를 갈망하고, 이를 위해 EVM 호환성을 완벽히 지원합니다. 덕분에 한 체인의 성공 사례는 24시간 내에 모든 체인으로 copypasta됩니다.
...
그렇기 때문에 앞서 말한 질문들도 좋지만, founder가 일단 프로젝트를 궤도에 올리기 위해 먼저 던지고 잡아 나가야 할 중요한 질문들은 다음과 같습니다:

- 생태계의 기존 제품들 및 그 이해관계자들과 얼마나 align 되어 있는가?
  - 금융공학적으로 incentives만을 이야기하는 것이 아니다. 그들의 존재할 이유(raison d'être)를 얼마나 enhance 해줄 수 있나?
- 경쟁 제품을 죽이지 못해도 좋다. 서로의 명분을 해치지 않는다면, 당장 파이를 쪼개더라도 충분히 매력적이다. 나중에 더 빨리 움직이면 된다.
- 지속적으로 시장에서 새로 생기는 네러티브를 따라 움직일 각오가 있는가?
